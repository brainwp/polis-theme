...
?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main biblioteca-main" role="main">
			...
			<div class="col-md-3" id="ajax-biblioteca-count">
				...
				if ( $query->have_posts() ) {
					...
					<ul class="nav nav-tabs">
						...
						foreach ( $categories as $category ) {
							?>
							<li id="tab-nav-<?php echo $category->slug; ?>" data-tab-element="#tab-<?php echo $category->slug; ?>">
								<a href="#tab-<?php echo $category->slug; ?>" data-toggle="tab"><?php echo $category->cat_name; ?></a>
							</li>
						<?php
						}
						?>
					...
					<div class="tab-content">
						...
						if ($i == 1) {
						?>
						<div class="tab-pane" id="tab-<?php echo $slug[$i]['term_slug'] ?>" data-nav="tab-nav-<?php echo $slug[$i]['term_slug'] ?>">
							<?php
							}
							?>
							<div class="col-md-12 item" data-term-slug="<?php echo $slug[$i]['term_slug'] ?>">
								...
								<div class="col-md-5 search_title">
									<div class="col-md-12">
										<a class="titulo" href="<?php echo $slug[$i]['title'];?>"><?php echo $slug[$i]['title']; ?></a>
									</div>
								...
								<div class="col-md-10 infos">
									<a class="autor" href="<?php echo get_home_url() . '/equipe/' .$slug[$i]['autor_user'];?>">Por <?php echo $slug[$i]['autor'];?></a>
									...
									<div class="pull-right download">
										...
										if(!empty($slug[$i]['downloadid'])):
											?>
											<a href="<?php echo wp_get_attachment_url($slug[$i]['downloadid']);?>" download>
